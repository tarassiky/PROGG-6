...
/*--- Type declarations ---*/
struct __pyx_opt_args_15integrate_nogil_integrate_nogil;
...
static double __pyx_f_15integrate_nogil_f_wrapper(double); /*proto*/
static double __pyx_f_15integrate_nogil_integrate_nogil(double, double, int __pyx_skip_dispatch, struct __pyx_opt_args_15integrate_nogil_integrate_nogil *__pyx_optional_args); /*proto*/
...
/* #### Code section: decls ### */
static PyObject *__pyx_pf_15integrate_nogil_integrate_nogil(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter); /* proto */
...
#define __pyx_n_u_integrate_nogil __pyx_string_tab[8]
...
#define __pyx_n_u_n_iter __pyx_string_tab[13]
...
#define __pyx_kp_b_iso88591_A_a_Cr_E_aq_Bb_9AS_1 __pyx_string_tab[21]
...
static double __pyx_f_15integrate_nogil_f_wrapper(double __pyx_v_x) {
  double __pyx_r;

  /* "integrate_nogil.pyx":4
 * 
 * cdef double f_wrapper(double x) nogil:
 *     return sin(x)             # <<<<<<<<<<<<<<
 * 
...
static PyObject *__pyx_pw_15integrate_nogil_1integrate_nogil(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static double __pyx_f_15integrate_nogil_integrate_nogil(double __pyx_v_a, double __pyx_v_b, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_15integrate_nogil_integrate_nogil *__pyx_optional_args) {
...
*/
          ...
          /* "integrate_nogil.pyx":14
 *         for i in range(n_iter):
 *             x = a + i * step
 *             acc += f_wrapper(x) * step             # <<<<<<<<<<<<<<
 *     return acc
*/
          __pyx_t_1 = __pyx_f_15integrate_nogil_f_wrapper(__pyx_v_x); if (unlikely(__pyx_t_1 == ((double)-1) && __Pyx_ErrOccurredWithGIL())) __PYX_ERR(0, 14, __pyx_L4_error)
...
static PyMethodDef __pyx_mdef_15integrate_nogil_1integrate_nogil = {"integrate_nogil", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_15integrate_nogil_1integrate_nogil, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_15integrate_nogil_1integrate_nogil(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "integrate_nogil", 0) < (0)) __PYX_ERR(0, 6, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("integrate_nogil", 0, 2, 3, i); __PYX_ERR(0, 6, __pyx_L3_error) }
      }
    } else {
      switch (__pyx_nargs) {
        case  3:
    ...
    if (values[2]) {
      __pyx_v_n_iter = __Pyx_PyLong_As_int(values[2]); if (unlikely((__pyx_v_n_iter == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 6, __pyx_L3_error)
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("integrate_nogil", 0, 2, 3, __pyx_nargs); __PYX_ERR(0, 6, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __pyx_r = __pyx_pf_15integrate_nogil_integrate_nogil(__pyx_self, __pyx_v_a, __pyx_v_b, __pyx_v_n_iter);
...
static PyObject *__pyx_pf_15integrate_nogil_integrate_nogil(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  double __pyx_t_1;
  struct __pyx_opt_args_15integrate_nogil_integrate_nogil __pyx_t_2;
  ...
  __pyx_t_1 = __pyx_f_15integrate_nogil_integrate_nogil(__pyx_v_a, __pyx_v_b, 1, &__pyx_t_2); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 6, __pyx_L1_error)
 ...
 *     cdef double step = (b - a) / n_iter
*/
  __pyx_mstate_global->__pyx_tuple[0] = PyTuple_Pack(1, __pyx_mstate_global->__pyx_int_100000); if (unlikely(!__pyx_mstate_global->__pyx_tuple[0])) __PYX_ERR(0, 6, __pyx_L1_error)
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 7; } index[] = {{1},{19},{20},{1},{18},{1},{18},{8},{15},{13},{5},{8},{10},{6},{8},{3},{12},{12},{10},{8},{6},{73}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (232 bytes) */
const char* const cstring = "x\332]NMJ\0031\030\255\303 bg\241\210\342\242\033{\200\202KA\220\372\263\225b\017\360\370&\375Z\202\231d:I\244s\203.\263\314r\216\3411\272\3141<\202\001\305\205o\361~x\274\217\357Aj\307\233\216\034C\233\215T\263\266\337\001\213L\213\376Y\n\207W\336\2717^\023\331^\013if\302t\306;\251\331\326Be\201\324p\035\t\256I\274\003k\257\005\360\357(\244\305\337N:n,\320P\036f4f\345\025\003\032\271\350\262R\223SkZ`\353I\375D\300\262\373\255\262[\345\177\274r\200c\233\371\203\224g{\030M\016\223\373\317y*\257\002\245\362:\026q\032\237b7\234\177\035\217N\307\351\244\332\277\204\313@a\233\252\263P\204ix\014u<J\325E\270\213\363\270\034\212\341&\225\343\375\3557{yl#";
    ...
    #endif
    #else /* compression: none (275 bytes) */
const char* const bytes = "?integrate_nogil.pyx__Pyx_PyDict_NextRefaasyncio.coroutinesbcline_in_traceback__func__integrate_nogil_is_coroutineitems__main____module__n_iter__name__pop__qualname____set_name__setdefault__test__values\320\000\034\320\034<\270A\330\004\026\220a\330\004\030\230\002\230\"\230C\230r\240\021\360\006\000\n\013\330\010\014\210E\220\025\220a\220q\330\014\020\220\002\220\"\220B\220b\230\001\330\014\023\2209\230A\230S\240\002\240!\330\004\013\2101";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (unlikely(!tuple_dedup_map)) return -1;
  {
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_integrate_nogil_pyx, __pyx_mstate->__pyx_n_u_integrate_nogil, __pyx_mstate->__pyx_kp_b_iso88591_A_a_Cr_E_aq_Bb_9AS_1, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
